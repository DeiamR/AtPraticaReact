    ...
    <Card>
        ...
        <CardContent>
            ...
            <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
                <TableHead>
                <TableRow sx={{backgroundColor: "#AA4"}}>
                    <TableCell>#</TableCell>
                ...
                <TableBody sx={{backgroundColor: "#aaaa"}}>
        ...
        <CardActions>
            <Button size="small" variant="contained" onClick={handleOpen} color='success'>Criar Tarefa</Button>
            <Button size="small" variant="outlined" sx={{color: 'white', backgroundColor: 'blue', borderColor: 'blue'}}>Cancelar</Button>
      </CardActions> 
    </Card>
    <div>
      <Modal
